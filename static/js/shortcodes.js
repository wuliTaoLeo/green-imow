(function ($) {
      ...
      return this.each(function () {
        ...
        for (var i in _units) {
          ...
          if (_self.update[_units[i]].label_container.length) {
            _self.update[_units[i]].single = _self.update[
              _units[i]
            ].label_container.data('label');
            _self.update[_units[i]].multi = _self.update[
              _units[i]
            ].label_container.data('label-multi');
          }
        }
  ...
  (function ($) {
    ...
    $.AviaMapsAPI.apiFiles = {
      ...
      finished: false,
      src:
        'https://maps.googleapis.com/maps/api/js?v=3.27&callback=aviaOnGoogleMapsLoaded',
    };
                ...
                $.avia_utilities.preload({
                  ...
                  single_callback: function () {
                    var links = masonry.find('.av-masonry-sort a'),
                      ...
                      allowed_filters = filter_container.data(
                        'av-allowed-sort'
                      );
  ...
  $.AviaFullscreenSlider = function (options, slider) {
    ...
    if ($.avia_utilities.supported.transition === undefined) {
      $.avia_utilities.supported.transition = $.avia_utilities.supports(
        'transition'
      );
    }
